...
HD_PWD='C:/Users/mhmou/Documents/2_Projects/1. Vivado/SpecCNN_v1_base/SpecCNN_v1_base.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spectral_cnn_layer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spectral_cnn_layer.tcl
