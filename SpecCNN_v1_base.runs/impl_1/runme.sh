...
HD_PWD='C:/Users/mhmou/Documents/2_Projects/1. Vivado/SpecCNN_v1_base/SpecCNN_v1_base.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log spectral_cnn_layer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source spectral_cnn_layer.tcl -notrace
